...
public class DoctorOfficePasswordNoteOverlay extends Scene {

    public PImage Background;
    public PImage PasswordNoteOverlay;
    public MouseHotspot BackHotspot;

    public DoctorOfficePasswordNoteOverlay() {
        super();
    ...
    @Override public void Load() {
        var a = Entry.Instance;
        PasswordNoteOverlay = a.Assets.GetSprite("scene/officePasswordNoteOverlay");
        Background = PasswordNoteOverlay;
    }
